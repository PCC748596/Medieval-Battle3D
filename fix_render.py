...
with open('public/js/game-loop.js', 'r') as f:
    code = f.read()

renderListBody = """function renderList(list) {
...
code = re.sub(r'function renderList\(list\) \{.*?\n\}\n\nfunction renderParticles\(\)', renderListBody + '\n\nfunction renderParticles()', code, flags=re.DOTALL)

with open('public/js/game-loop.js', 'w') as f:
    f.write(code)
